...
using NoiThat.Module.BusinessObjects.ChungTu;
using System;
...
namespace NoiThat.Module.BusinessObjects.DanhMuc
{
    [DefaultClassOptions]
    ...
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        ...
        {
            get { return _Name; }
            set { SetPropertyValue<string>(nameof(Warranty_period), ref _Name, value); }
        }
