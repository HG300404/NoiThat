...
using NoiThat.Module.BusinessObjects;
using Microsoft.Extensions.DependencyInjection;

namespace NoiThat.Module.DatabaseUpdate;
...
#if !RELEASE
        if (TenantName == null) {
            _ = CreateTenant("company1.com", "NoiThat_company1");
            _ = CreateTenant("company2.com", "NoiThat_company2");
